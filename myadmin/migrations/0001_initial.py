    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateField(default=datetime.date(2023, 3, 11))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='myadmin.category')),
                ('seller', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='myadmin.seller')),
        ...
        migrations.AddField(
            model_name='order',
            name='seller',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='myadmin.seller'),
        ),
        migrations.CreateModel(
            name='Feedback',
            fields=[
